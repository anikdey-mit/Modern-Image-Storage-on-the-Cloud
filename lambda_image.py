...
def lambda_handler(event, context):
    ...
    if event['httpMethod'] == 'POST' : 
        ...
        strBucket = 'nad123'
        strKey = 'yolov3-tiny.weights'
        strWeightFile = '/tmp/yolov3-tiny.weights'
        downloadFromS3(strBucket,strKey,strWeightFile) 
           

        strKey = 'yolov3-tiny.cfg'
        strConfigFile = '/tmp/yolov3-tiny.cfg'
        ...
        for out in outs:
            ...
            for detection in out:
                ...
                if confidence > 0:
                    detected_objects.append({"label": str(classes[class_id]), "accuracy": str(round(confidence * 100, 2))})
